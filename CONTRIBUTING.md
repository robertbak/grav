...
7. **Check the problem on Grav 1.2** &mdash; if you're using Grav 1.0, latest stable release, please also check if you can replicate the issue on Grav 1.2 RC as many bugs are already solved in the next Grav release.
